...
<body>
 <div class="header-search">
      ...
      <form action="../seold/skeyword" method="POST">
        <input class="input-search" type="text" name="title" placeholder="กรุณากรอกรหัส">
        <input type="submit" name="submit" value="Search">
      </form>

      <form action="../seold/skey_province" method="POST">
        <input class="input-search" type="text" name="title" placeholder="กรุณากรอกจังหวัด">
        <input type="submit" name="submit" value="Search">
      </form>

      <form action="../seold/skey_name" method="POST">
        <input class="input-search" type="text" name="title" placeholder="กรุณากรอกชื่อ">
        <input type="submit" name="submit" value="Search">
      </form>

      
      <form action="../seold/skey_yearend" method="POST">
        <input class="input-search" type="text" name="title" placeholder="กรุณากรอกปีที่จบ">
        <input type="submit" name="submit" value="Search">
      </form>

      <form action="../seold/skey_moorean" method="POST">
        <input class="input-search" type="text" name="title" placeholder="กรุณากรอกหมู่เรียน">
        <input type="submit" name="submit" value="Search">
      </form>
