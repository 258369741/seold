...
class add_model extends CI_Model {
		...
		function select_all(){
			$this->db->select('se_studentid, se_numna, se_name,se_lastname,se_birthday,se_idcard,se_tel,se_session,se_yearend,se_skill,se_facebook,se_email,se_lakete,se_mu,se_district,se_aumpa,se_province,se_status_id');
		...
		function search_province($province){
			$this->db->like('se_province',$province);
			$result = $this->db->get('se_register');
			return $result;
		}

		function search_name($name){
			$this->db->like('se_name',$name);
			$result = $this->db->get('se_register');
			return $result;
		}

		function search_yearend($yearend){
			$this->db->like('se_yearend',$yearend);
			$result = $this->db->get('se_register');
			return $result;
		}

		function search_moorean($moorean){
			$this->db->like('se_session',$moorean);
			$result = $this->db->get('se_register');
			return $result;
		}
