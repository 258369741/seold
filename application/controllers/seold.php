...
class seold extends CI_Controller {
	...
	public function skey_province(){
		$province = $this->input->post('title');
		$data['AM'] = $this->AM->search_province($province);
		$this->load->view('View_Select',$data);		
	}

	public function skey_name(){
		$name = $this->input->post('title');
		$data['AM'] = $this->AM->search_name($name);
		$this->load->view('View_Select',$data);		
	}

	public function skey_yearend(){
		$yearend = $this->input->post('title');
		$data['AM'] = $this->AM->search_yearend($yearend);
		$this->load->view('View_Select',$data);		
	}

	public function skey_moorean(){
		$moorean = $this->input->post('title');
		$data['AM'] = $this->AM->search_moorean($moorean);
		$this->load->view('View_Select',$data);		
	}
	...
	public function add_Regis(){
		$data = array(
			...
			'se_session' => $this->input->post("se_session"),
